...
【ongoing】优化 BGM
【ongoing】id 改 jwt; 简单的注册验证
【ongoing】模糊搜索 -- 最接近的结果用列表呈现;
【ongoing】右键菜单加入复制; 使用 百度 搜索
【ongoing】使用说明 文字版/图片版/视频版
【ongoing】在最外围加事件 干掉所有可见 "弹窗" 设置开关对象, 使用捕获模式
【ongoing】改个人中心的点击为 hover
【ongoing】在页面写一个外部搜索 google bing baidu
【ongoing】账户添加 avatar
【ongoing】音乐左边可以有一个小方块, 拖动小方块进入全屏音乐

music 三种模式 音乐模式 / 英语模式 / ktv 模式. 所以 player song 设计成命名试图, 感觉和那个记忆卡片差不多了哈哈, 我真的很喜欢这个"旋转"的; 这样就能体会到并列命名试图的好处. 果然, 需要才最好体会知识 -- 我要做一个什么, 有什么知识能够帮我 or 我有一个这个知识, 我怎么把它用上
