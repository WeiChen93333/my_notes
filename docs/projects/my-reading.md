...
- 可以将整篇文章分割成句子导入...不过没有太大必要, 外部文章可以作为语料库的来源, 成为词典的补充, 不过感觉还是自己阅读过的才行
- 其实还可以做句子填充呢...随机消掉其中几个词, 单词也是, 随机消掉几个字母, 哈哈 总之, 先搞刚需, 比如资料夹, 就不算刚需
**问题与解决**
...
当次查询跳转其他单词后, 返回另一个单词, 可以用数组, 感觉这个功能还是很需要的...emmm, 最终还是做了跳转查词, 所以啊, 不要纠结, 不要想太多步, 干就完了, 有的时候干着干着灵感来了, 一点点小改变, 就能做到以前很没有头绪的功能
<!-- 突然想到可以用查词历史来做一些事情啊, 一旦查词历史改变, 立刻执行 searchThroughDict, 那么就不用发送很多事件了...优秀...九九归一法啊...把不同的变化归到一种变化 -->
**问题与解决**
